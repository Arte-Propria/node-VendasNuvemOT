...
router.get(
  '/creatives/tiktok/:store/:createdAtMin/:createdAtMax',
  getTikTokCreatives,
);
...
router.get(
  '/comparar_tiny/:store/:dataInicial/:dataFinal',
  compararPedidosTiny,
);
router.get(
  '/comparar_nuvem/:store/:dataInicial/:dataFinal',
  compararPedidoNuvem,
);
...
// Rotas de reembolsos
router.get(
  '/refunds/:store/:refundType/:createdAtMin/:createdAtMax',
  getRefunds,
);
...
// Rotas Marketplace
router.get(
  '/marketplace/orders/:marketplace/:createdAtMin/:createdAtMax',
  getOrdersByMarketplace,
);
router.get(
  '/marketplace/orders/:createdAtMin/:createdAtMax',
  getOrdersAllMarketplace,
);

// Rotas PCP
router.get(
  '/pcp/orders/:createdAtMin/:createdAtMax',
  getOrdersAllMarketplaceOptimized,
);
